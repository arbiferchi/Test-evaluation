...
//    }
    ...
    @PostMapping("/{courseId}/{_id}/submit")
    public Integer submitQuiz(@PathVariable String courseId, @PathVariable String _id, @RequestParam String userId, @RequestBody List<Response> responses) {
        return quizService.submitQuiz(userId, courseId, _id, responses).getBody();
    }
